...
public class CauldronFluidRecipe extends CauldronRecipeMatchRecipe {
	 ...
	 */
	public CauldronFluidRecipe(RecipeMatch input, Fluid fluid, ItemStack result, @Nullable Boolean boiling, int levels, SoundEvent sound) {
	 ...
	 * @param levels  Amount of levels consumed by the recipe, also determines how many levels are required to perform the recipe
	 */
	public CauldronFluidRecipe(RecipeMatch input, Fluid fluid, ItemStack result, @Nullable Boolean boiling, int levels) {
	 ...
	 * @param sound   Sound to play when performing the recipe
	 */
	public CauldronFluidRecipe(RecipeMatch input, Fluid fluid, ItemStack result, @Nullable Boolean boiling, SoundEvent sound) {
	 ...
	 * @param boiling If true, the cauldron must be above fire, if false it must not be above fire. Set to null to ignore fire
	 */
	public CauldronFluidRecipe(RecipeMatch input, Fluid fluid, ItemStack result, @Nullable Boolean boiling) {
