...
public abstract class RecipeMatchCauldronRecipe implements ISimpleCauldronRecipe {
   ...
   */
  public RecipeMatchCauldronRecipe(RecipeMatch input, ItemStack result, @Nullable Boolean boiling, int levels, SoundEvent sound) {
    this.input = input;
    this.result = result;
    this.levels = levels;
   ...
   * @param levels  Amount of levels consumed by the recipe, also determines how many levels are required to perform the recipe
   */
  public RecipeMatchCauldronRecipe(RecipeMatch input, ItemStack result, @Nullable Boolean boiling, int levels) {
