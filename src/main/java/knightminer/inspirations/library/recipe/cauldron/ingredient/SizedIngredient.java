 ...
 * TODO: Switch to Mantle version in 1.16.2
 */
public class SizedIngredient implements Predicate<ItemStack> {
  ...
  /**
   * Gets a new sized ingredient
   * @param ingredient    Ingredient
   * @param amountNeeded  Number needed to match
  ...
  /**
   * Gets the number of items needed for this ingredient
