...
public class InspirationsRegistry {
	...
	private static Multimap<ItemMetaKey, AnvilSmashingItemRecipe> anvilSmashingItems = LinkedListMultimap.create();
	/**
  ...
  /**
   * Create a new recipe to smash items with an anvil.
   *
   * @param inputStack the input stack of the recipe
   * @return a builder object that allows to specify the details of the recipe
   */
  public static AnvilSmashingItemRecipeBuilder createAnvilSmashingItemRecipe(@Nonnull ItemStack inputStack) {
    return AnvilSmashingItemRecipeBuilder.create(inputStack);
  }

  /**
   * Register recipe for smashing items with a falling anvil.
   *
   * @param recipe the recipe to register
   */
  public static void registerAnvilSmashingItem(@Nonnull AnvilSmashingItemRecipe recipe) {
    ItemMetaKey key = new ItemMetaKey(recipe.getStackInput());
    anvilSmashingItems.put(key, recipe);
  }
  ...
  /**
   * Gets the recipe of an anvil landing on the given item stack in the block space of the anvil.
   *
   * @param stackInput Input stack that is getting smashed by the anvil
   * @return the recipe with the information of the smash result
   */
  public static Collection<AnvilSmashingItemRecipe> getAnvilSmashItemRecipe(ItemStack stackInput) {
    ItemMetaKey key = new ItemMetaKey(stackInput);
    Collection<AnvilSmashingItemRecipe> recipes = anvilSmashingItems.get(key);
  ...
  public static Collection<AnvilSmashingItemRecipe> getAllAnvilSmashItemRecipes() {
      return ImmutableList.copyOf(anvilSmashingItems.values());
  }
