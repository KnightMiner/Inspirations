 ...
 */
public class FillBlockTexture extends LootFunction {
	public FillBlockTexture(ILootCondition[] conditions) {
		super(conditions);
	}
	...
	public static class Serializer extends LootFunction.Serializer<FillBlockTexture> {
		public Serializer(ResourceLocation location) {
			super(location, FillBlockTexture.class);
		}

		@Nonnull
		@Override
		public FillBlockTexture deserialize(@Nonnull JsonObject json, @Nonnull JsonDeserializationContext ctx, @Nonnull ILootCondition[] conditions) {
			return new FillBlockTexture(conditions);
		}
	}
}
