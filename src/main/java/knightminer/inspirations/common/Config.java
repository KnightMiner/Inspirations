...
public class Config {
    ...
    private static String[] anvilSmashingItems = {
            "# Destroy if higher than 6 blocks",
            "minecraft:bone->6->",

            "# Each block adds one extra",
            "minecraft:bone->5->minecraft:dye:15*5",
            "minecraft:bone->4->minecraft:dye:15*4",
            "minecraft:bone->3->minecraft:dye:15*3",
            "minecraft:bone->2->minecraft:dye:15*2",
            "minecraft:bone->1->minecraft:dye:15*1",

            "# Blockstate ",
            "minecraft:reeds;minecraft:iron_block->minecraft:sugar*3",

            "# Material ",
            "minecraft:yellow_flower;#material:anvil->minecraft:dye:11*6",

            "# Hardness",
            "minecraft:yellow_flower;#hard:50->minecraft:dye:11*3",

            "# Ore Dict ",
            "minecraft:red_flower;#ore:logWood->minecraft:dye:11*6",

            "# Harvest Level ",
            "minecraft:red_flower;#level:4->",
            "minecraft:red_flower;#level:2,3->minecraft:dye:1*3",

            "# Break melon block",
            "minecraft:iron_bars;minecraft:melon_block->minecraft:melon*6;minecraft:air"
    };
	...
	public static boolean unstackableRecipeAlts = true;// heartbeet
    ...
    public static void init(FMLInitializationEvent event) {
        ...
        anvilSmashingItems = configFile.get("recipes.anvilSmashingItems", "smashingItems", anvilSmashingItems,
                "").getStringList();
        processAnvilSmashingItems(anvilSmashingItems);
    ...
    /**
     * Parses the item smashing recipes.
     *
     * @param transformations the recipes
     */
    private static void processAnvilSmashingItems(String[] transformations) {
        if (!enableAnvilSmashing) {
            return;
        }

        Arrays.stream(transformations)
                .forEach(AnvilSmashingItemRecipeBuilder::processAnvilSmashingItemsEntry);
    }
    ...
    public static class ConfigProperty implements IConditionFactory {
        ...
        private static boolean propertyEnabled(String property) {
            switch (property) {
                // building
                case "bookshelf":
                    return enableBookshelf;
                case "colored_books":
                    return enableColoredBooks;
                case "enlightened_bush":
                    return enableEnlightenedBush;
                case "flowers":
                    return enableFlowers;
                case "glass_door":
                    return enableGlassDoor;
                case "mulch":
                    return enableMulch;
                case "path":
                    return enablePath;
                ...
                // utility
                case "bricks_button":
                    return enableBricksButton;
                case "carpeted_trapdoor":
                    return enableCarpetedTrapdoor;
                case "collector":
                    return enableCollector;
                case "pipe":
                    return enablePipe;
                case "redstone_barrel":
                    return enableRedstoneBarrel;
                case "redstone_book":
                    return enableRedstoneBook;
                case "redstone_torch_lever":
                    return enableRedstoneTorchLever;
                case "torch_lever":
                    return enableTorchLever;

                // tools
                case "crook":
                    return separateCrook;
                case "lock":
                    return enableLock;
                case "nether_crook":
                    return netherCrooks;
                case "redstone_charge":
                    return enableRedstoneCharge;

                // tweaks
				case "unstackable_alts": return unstackableRecipeAlts;

				// recipes
                case "cauldron_dyeing":
                    return enableCauldronDyeing;
                case "cauldron_fluids":
                    return enableCauldronFluids;
                case "cauldron_potions":
                    return enableCauldronPotions;
                case "extra_dyed_bottle_recipes":
                    return extraBottleRecipes;
                case "patch_vanilla_dye_recipes":
                    return patchVanillaDyeRecipes;
            }
