	...
	public static class ConfigProperty implements IConditionSerializer {
		...
		public BooleanSupplier parse(@Nonnull JsonObject json) {
			...
			switch(prop) {
				...
				case "colored_books": return Config::enableColoredBooks;
				...
				case "redstone_book": return Config::enableRedstoneBook;
				...
				case "craft_waypoint_compass": return Config::craftWaypointCompass;
				case "copy_waypoint_compass": return Config::copyWaypointCompass;
				case "dye_waypoint_compass": return Config::dyeWaypointCompass;
				...
				// recipes
				case "cauldron_dyeing": return Config::enableCauldronDyeing;
				case "cauldron_fluids": return Config::enableCauldronFluids;
				case "cauldron_potions": return Config::enableCauldronPotions;
				case "extra_dyed_bottle_recipes": return Config::extraBottleRecipes;
				case "patch_vanilla_dye_recipes": return Config::patchVanillaDyeRecipes;
			}
