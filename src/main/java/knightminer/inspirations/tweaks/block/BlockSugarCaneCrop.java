...
public class BlockSugarCaneCrop extends BlockBlockCrop {
	...
	private static final VoxelShape[] BOUNDS = {
			Block.makeCuboidShape(0.125, 0, 0.125, 0.875, 0.125, 0.875),
			Block.makeCuboidShape(0.125, 0, 0.125, 0.875, 0.25,  0.875),
			Block.makeCuboidShape(0.125, 0, 0.125, 0.875, 0.375, 0.875),
			Block.makeCuboidShape(0.125, 0, 0.125, 0.875, 0.5,   0.875),
			Block.makeCuboidShape(0.125, 0, 0.125, 0.875, 0.625, 0.875),
			Block.makeCuboidShape(0.125, 0, 0.125, 0.875, 0.75,  0.875),
			Block.makeCuboidShape(0.125, 0, 0.125, 0.875, 0.875, 0.875)
	};
